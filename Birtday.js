...
(hh = h / 2),
  (opts = {
    ...
    strings: ["HAPPY", "BIRTHDAY!", "to You", "Maysa"],
    charSize: 30,
    charSpacing: 35,
    lineHeight: 40,
  ...
  // Dentro da função Letter.prototype.step, na fase "balloon"
    ...
    var balloonFlyCounter = 0; // Contador de tempo para os balões voarem
      ...
      if (this.spawning) {
          ...
          // Aumenta o contador de tempo de voo
          balloonFlyCounter++;
          ...
          // Verifica se o balão saiu da tela ou se o tempo de voo máximo foi alcançado
          if (this.cy + this.size < -hh || this.cx < -hw || this.cy > hw || balloonFlyCounter >= balloonFlyTime) {
              this.phase = "done";
          }
      }
  }
